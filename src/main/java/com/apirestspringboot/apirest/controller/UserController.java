...
import com.apirestspringboot.dto.UserDto;
...
public class UserController {
    ...
    public ResponseEntity<Object> saveUser(@RequestBody @Valid UserDto userDto) {
        ...
        if (userService.existsByModelCarAndCelNumber(
                userDto.getModelCar(),
                userDto.getCelNumber())) {

            return ResponseEntity.status(HttpStatus.CONFLICT)
                    .body("Conflict: user with modelCar and celNumber already exists in database.");
        }
    ...
    public ResponseEntity<Object> getUsers(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(userService.retornaTodos(pageable));
    }
    ...
    @PutMapping("/users/{id}")
    public ResponseEntity<Object> atualizeUser(
    ...
    public ResponseEntity<Object> atualizePartialUser(
            @PathVariable UUID id,
    ...
    public ResponseEntity<Object> deleteUser(@PathVariable UUID id) {
        ...
        userService.deletarUser(userOptional.get());
